...
class MovieList extends Component {
  ...
  handleSubmit = event => {
    ...
    axios
      .get('http://localhost:5000/api/movies/search', {
        params: {
          query: searchInputValue,
        },
      }).then(response => this.setState({ movies: response.data, searchInputValue: '' }));
  };
