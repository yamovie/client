  ...
  render() {
    ...
    return (
      <div className="parent">
        <button className="card-button" type="button" onClick={() => this.toggleCard()}>
          <div className="card-container">
            <div className="movieitem-info">
              <img className="movieitem-poster" src={poster} alt={movie.title} />
              <div className="movieitem-stats">
          ...
          <div className="movieitem-card" style={cardStyles}>
            ...
            <div className="description">
              <div className="description-content">
                <button type="button" className="trailer-button" onClick={() => this.toggleTrailer()}>Watch Trailer</button>
                {trailerVisible && <TrailerModal toggleTrailer={this.toggleTrailer} trailer={movie.videos} />}
  ...
  return (
    <div id="streams">
      {offers.stream.length > 0 ? (
        ...
        <h3>No streams currently available for this title</h3>
      )}
    </div>
  );
};
